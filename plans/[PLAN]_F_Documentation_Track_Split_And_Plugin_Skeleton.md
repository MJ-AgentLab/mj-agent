...
| v1.1 走 [[../docs/rule/[STANDARD]_MJ_Agent_Documentation_Management_Framework_v1.1\|v1.1]] §5.6.2 archive 流程 | `git mv docs/rule/[STANDARD]_..._Framework_v1.1.md docs/archive/rule/[STANDARD]_..._Framework_v1.1.md`；archive 副本 frontmatter `state: active → deprecated`；body 顶部加状态横幅指向 v2.0 |
