...
[[STANDARD]_MJ_Agent_Documentation_Management_Framework_v1.1|mj-agent 文档治理框架 v1.1]] 及配套交付（4 份模板、9 份 ADR、`docs/INDEX.md`、src 源码改造、PR 模板补丁）已经全部落地到 `phase0-next-plans/` 这个 worktree。但两类事实尚未被验证：
...
| V13 | CLAUDE.md 段落能被 Claude 读到并执行 | 在 Claude Code 里问："项目的文档治理入口在哪？" | Claude 引用 `docs/rule/[STANDARD]_MJ_Agent_Documentation_Management_Framework_v1.1.md` 和 `docs/INDEX.md` |
...
Claude 应当引用 `docs/rule/[STANDARD]_MJ_Agent_Documentation_Management_Framework_v1.1.md` 和 `docs/INDEX.md`。如果它引用其他文件或说"没找到"，说明 CLAUDE.md 的 Documentation 段落要再精简或加粗。
