...
- 🔄 **PR-1** — `feature/98-multi-env-compose-layering`（issue [#98](https://github.com/MJ-AgentLab/mj-agent/issues/98)；commit `34e82f0`；in-progress；待 push + PR 创建 + merge）
- ⏳ PR-2 — `feature/llm-provider-abstraction`（blocked by PR-1 merge）
