...
- **派生中的文档治理框架**：[[../rule/[STANDARD]_MJ_Agent_Documentation_Management_Framework_v1.1|Framework v1.1]]（draft；本 ADR 撰写时为 v1.0，由 [[ADR]_011_Doc_Versioning_And_Archive_Convention|ADR-011]] 升级至 v1.1）
...
- [[../rule/[STANDARD]_MJ_Agent_Documentation_Management_Framework_v1.1|MJ-Agent 文档管理框架 v1.1]] §6.4 / §7.1 A6 —— CLAUDE.md 同步约束（本 PR 故意不过的门禁）
- mj-system 源文档：
