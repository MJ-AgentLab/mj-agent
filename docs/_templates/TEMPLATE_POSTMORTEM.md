...
### 与 execution-loop §3.1 必停规则的关系

- 本事件是否触 §3.1 必停项之一？<是 / 否；如是，哪几项。清单以 `sdd/workflows/execution-loop.md` §3.1 为准——**不要在此硬写条数**，它随 kernel 增补而变（2026-08-07 实况：通用 12 + mj-agent 专属 4）>
