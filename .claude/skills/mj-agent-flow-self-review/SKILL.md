...
## Step 3: execution-loop §6 Dual-Section Verify

按 execution-loop §6（双段约束；实操矩阵见 §5），自检结果**严格分两段**：
...
- **不要** 把测试结果写到 AI 自检段（违反 execution-loop §6 双段）
