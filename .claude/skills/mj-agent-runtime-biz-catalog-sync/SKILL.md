...
- [[../../../docs/rule/[STANDARD]_MJ_Agent_AI_Engineering_Execution_HITL_Prompt_v1.0|HITL_Prompt v1.0]] §3.1 必停 12 + §4.4 §6.6（biz_catalog drift detection in Repo Scan）+ §4.7 Rule 9
