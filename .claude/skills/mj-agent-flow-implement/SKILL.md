...
The 4th orchestrator in `mj-agent-flow-*` family — operationalizes [[../../../docs/rule/[STANDARD]_MJ_Agent_AI_Engineering_Execution_HITL_Prompt_v1.0|HITL_Prompt v1.0]] §4.7 Rules 1-15 hard constraints. Runs **during** coding (after Plan/SPEC confirmed, before Stage 10 verification), enforcing 4 methodology pillars:
...
**Reference**:
- [[../../../docs/rule/[STANDARD]_MJ_Agent_AI_Engineering_Execution_HITL_Prompt_v1.0|HITL_Prompt v1.0]] §4.7（Stage 8 Implementation, Rules 1-15）
...
**3 风味判定**（mj-agent 专属，参 [[../../../docs/rule/[STANDARD]_MJ_Agent_AI_Engineering_Execution_HITL_Prompt_v1.0|HITL_Prompt]] §4.7 + ADR-015 §决策点 3）：
