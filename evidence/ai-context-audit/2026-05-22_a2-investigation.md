...
- **ADR-013** (`decisions/ADR-013_Plugin_SKILL_md_Schema_Separation.md` — 决策点 1-5; silent on V4 implementation per Episode #2-3)
- **ADR-032** (`decisions/ADR-032_Claude_Skill_Schema_Monitoring.md#L75,L91,L141` canonical regex-strip refs; `#L144-L145` implicit enum broadening Episode #2-5)
